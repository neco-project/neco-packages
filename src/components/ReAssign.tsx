...
// گزینه‌های نمونه برای "Reassign with"
...
const Reassign: React.FC = () => {
  // حالت‌های مربوط به بخش "Reassign"
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 bg-white rounded shadow space-y-6">
      ...
      {/* ردیف اول: ستون چپ: "Reassign with" + "Allowed Duration" (زیر هم) - ستون راست: "Reassign Instruction" (Combobox) */}
      ...
      {/* دکمه‌های نهایی (Reassign و Cancel) به صورت تمام عرض و کنار هم */}
